...
const cast = [
  { emoji: '🤡', img: fullCostume, imgPosition: 'center 15%', nameEs: 'Andrés el Payasito', nameEn: 'Andrés el Payasito', roleEs: '🏳️‍🌈 Estrella Principal — El Títere Humano', roleEn: '🏳️‍🌈 Lead Star — The Human Puppet', descEs: '¡El payaso títere de mano más querido del mundo! Abiertamente gay y orgullosamente payaso. Maestro del humor, coleccionista de muñecos y la alegría en persona.', descEn: 'The world\'s most beloved hand puppet clown! Openly gay and proudly a clown. Master of humor, toy collector, and joy personified.', bg: 'var(--red)' },
  { emoji: '🦍', img: gorilaImg, imgPosition: 'center 25%', nameEs: 'La Gorila', nameEn: 'The Gorilla', roleEs: '🍌 Co-Estrella — La Compañera Inseparable', roleEn: '🍌 Co-Star — The Inseparable Companion', descEs: 'Salvaje, divertida y con más ritmo que nadie. La gorila hembra que roba el show en cada función.', descEn: 'Wild, funny, and with more rhythm than anyone. The female gorilla who steals the show every performance.', bg: 'var(--purple)' },
  { emoji: '🧑‍✈️', img: duoParty, imgPosition: 'center 20%', nameEs: 'El Capitán', nameEn: 'The Captain', roleEs: '₿ Compañero — El Cripto-Aventurero', roleEn: '₿ Partner — The Crypto-Adventurer', descEs: 'Siempre hablando de Bitcoin y blockchain, El Capitán trae el humor tech al escenario. ¡HODL the laughs!', descEn: 'Always talking Bitcoin and blockchain, The Captain brings tech humor to the stage. HODL the laughs!', bg: 'var(--blue)' },
]
            ...
            <RevealOnScroll key={i}>
              <div className="act-card">
                <div className="act-image" style={{ background: act.gradient }}>
                  {act.img ? <img src={act.img} alt={act.titleEs} style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: act.imgPosition || 'center 20%' }} /> : act.emoji}
                </div>
            ...
            <RevealOnScroll key={i}>
              <div className="cast-card">
                <div className="cast-avatar" style={{ background: member.bg }}>
                  {member.img ? <img src={member.img} alt={member.nameEs} style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: member.imgPosition || 'center 20%' }} /> : member.emoji}
                </div>
